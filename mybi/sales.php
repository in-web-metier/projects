...
<section class="business demo">
    <div class="container demo">
        <ul class="nav cols">
            ...
            <li class="two-col three active" onclick="ga('send', 'event', 'Button', 'Бизнес-аналитика слайд Продажи');">
                <p>Продажи</p>
                <div></div>
            </li>
        ...
        <div class="slider-container">
            <div class="slider ten-col">
                <div class="wrapper-demo">
                    <div class="report">
                       <iframe width="1000" height="810" src="https://app.powerbi.com/view?r=eyJrIjoiZDhlOTcyYzktYjU1MS00NmE4LTlkMDEtOGJjMWZhMDhiMDk5IiwidCI6IjA1YjY1OTU3LTM5NTktNDgwMC04ODhkLWViZjJkYmQ3YzMwMiIsImMiOjl9" frameborder="0" allowFullScreen="true"></iframe>
                    </div>
                    <div class="video">
                        <div class="video-right">
                            <span class="demo-report_title">Описание</span>
                            <p>Данный отчет построен на выгрузке из CRM и 1С системы клиента. В верхней части отчета мы можем выбрать необходимую нам меру, которая будет отображаться в отчете - количество продаж или сумма продаж. Кроме этого мы можем выбрать категорию продукта или интересующего нас менеджера для фильтрации отчета. В отчете присутствует визуализация по конкретным названиям товаров, в которой можно воспользоваться поиском и посмотреть динамику продаж и распределение продаж товара по менеджерам.</p>
                        </div>
                    </div>
