...
<section class="business demo">
    <div class="container demo">
        <ul class="nav cols">
            ...
            <li class="two-col four active" onclick="ga('send', 'event', 'Button', 'Бизнес-аналитика слайд Финансы');">
                <p>Финансы</p>
                <div></div></li>
        ...
        <div class="slider-container">
           <div class="slider ten-col">
                <div class="wrapper-demo">
                    <div class="report">
                       <iframe width="1000" height="810" src="https://app.powerbi.com/view?r=eyJrIjoiMWU4Y2I3ZmMtODNhNy00NmYwLWIyYzMtYmJjMDkwNjAyZDFhIiwidCI6IjA1YjY1OTU3LTM5NTktNDgwMC04ODhkLWViZjJkYmQ3YzMwMiIsImMiOjl9" frameborder="0" allowFullScreen="true"></iframe>
                    </div>
                    <div class="video">
                        <div class="video-right">
                            <span class="demo-report_title">Описание</span>
                            <p>Данный отчет построен на Excel файлах, хранящих финансовые данные 3х организаций (P&L). Отчет позволяет увидеть каждую организацию отдельно или вместе с другими с помощью фильтра по названию организации. В самом теле отчета мы можем увидеть основные категории выручки и затрат, их соотношение помесячно, а также динамику и рентабельность.</p>
                        </div>
                    </div>
