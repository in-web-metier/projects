...
<section class="offer">
    <div class="header">
        <div class="container">
            ...
            <div class="cols" data-scrollreveal="move 0px 3s after 1.1s">
                ...
                <p style="padding-left: 24px;"><a href="#automate" class="bluelink nav" id="trybutton2" onclick="ga('send', 'event', 'Button', 'Попробовать демо');">Демо отчеты</a></p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="video">
                <h2>Бесплатный вебинар<br/> 27 июня</h2>
...
<section class="automate" id="automate">
    <div class="container">
        ...
        <div class="slide2">
		<div class='img-block-modal'></div>
            <h1>Посмотреть демо-отчет</h1>
            ...
            <form class="cols hiddensend" method="post" action="send.php">
                ...
                <div class="buttonblock">
                    ...
                    <div class="form-agree">
                        <input class="checkbox-agree" id="agree-automate" type="checkbox">
                        <label for="agree-automate">Я принимаю условия</label>
                    </div>
                    <a class="button disabled" id="demoenter" onclick="ga('send', 'event', 'Button', 'Вход в демо');">Вход</a>
                </div>
                            ...
                            <div class="slider-demo-enter">
                                ...
                                <form class="cols hiddensend demoform" method="post" action="send.php">
                                    ...
                                    <div class="buttonblock">
                                        <a class="button empty cancel" onclick="ga('send', 'event', 'Button', 'Отмена демо');">Отмена</a>
                                        <div class="form-agree">
                                            <input class="checkbox-agree" id="agree-slider1" type="checkbox">
                                            <label for="agree-slider1">Я принимаю условия</label>
                                        </div>
                                        <a class="button disabled" id="demoenter2" onclick="ga('send', 'event', 'Button', 'Вход в демо');">Вход</a>
                                    </div>
                                    <input type="hidden" name="form_name" value="Вход в демо">
                                </form>
                            </div>
                            ...
                            <div class="slider-demo-enter">
                                ...
                                <form class="cols hiddensend demoform" method="post" action="send.php">
                                    ...
                                    <div class="buttonblock">
                                        <a class="button empty cancel" onclick="ga('send', 'event', 'Button', 'Отмена демо');">Отмена</a>
                                        <div class="form-agree">
                                            <input class="checkbox-agree" id="agree-slider2" type="checkbox">
                                            <label for="agree-slider2">Я принимаю условия</label>
                                        </div>
                                        <a class="button disabled" id="demoenter2" onclick="ga('send', 'event', 'Button', 'Вход в демо');">Вход</a>
                                    </div>
                                    <input type="hidden" name="form_name" value="Вход в демо">
                            ...
                            <div class="slider-demo-enter">
                                ...
                                <form class="cols hiddensend demoform" method="post" action="send.php">
                                    ...
                                    <div class="buttonblock">
                                        <a class="button empty cancel" onclick="ga('send', 'event', 'Button', 'Отмена демо');">Отмена</a>
                                        <div class="form-agree">
                                            <input class="checkbox-agree" id="agree-slider3" type="checkbox">
                                            <label for="agree-slider3">Я принимаю условия</label>
                                        </div>
                                        <a class="button disabled" id="demoenter2" onclick="ga('send', 'event', 'Button', 'Вход в демо');">Вход</a>
                                    </div>
                                    <input type="hidden" name="form_name" value="Вход в демо">
                            ...
                            <div class="slider-demo-enter">
                                ...
                                <form class="cols hiddensend demoform" method="post" action="send.php">
                                    ...
                                    <div class="buttonblock">
                                        <a class="button empty cancel" onclick="ga('send', 'event', 'Button', 'Отмена демо');">Отмена</a>
                                        <div class="form-agree">
                                            <input class="checkbox-agree" id="agree-slider4" type="checkbox">
                                            <label for="agree-slider4">Я принимаю условия</label>
                                        </div>
                                        <a class="button disabled" id="demoenter2" onclick="ga('send', 'event', 'Button', 'Вход в демо');">Вход</a>
                                    </div>
                                    <input type="hidden" name="form_name" value="Вход в демо">
...
<section class="ourclients">
    <div class="container">
        ...
        <div class="clients">
			...
			<div><img src="img/logo-te-small.png" width="190"><div></div></div>
            <div><img src="img/logo-tr.png" width="190"><div></div></div>
        </div>
    </div>
</section>
...
<section class="reviews">
    <div class="container">
        ...
        <iframe src="https://www.youtube.com/embed/lfY8orYi6jE" frameborder="0" allowfullscreen></iframe>
    </div>
</section>
    ...
    <div class="container cols">
        ...
        <div class="five-col">
            <form action="send.php" class="hiddensend" method="post">
                ...
                <div class="form-agree">
                    <input class="checkbox-agree" id="agree-finish" type="checkbox">
                    <label for="agree-finish">Я принимаю условия</label>
                </div>
                <a class="button disabled" onclick="ga('send', 'event', 'Button', 'Форма Пилотный проект, кнопка Далее');">Далее</a>
...
<footer>
    <div class="container cols">
        ...
        <div class="five-col cols contacts">
            ...
            <a href="connect/politics.pdf" class="politics" target="_blank">
...
<script>
    $(".checkbox-agree:checkbox").change(function() {
        if(this.checked) {
