...
<div class="form-vertical row">
  <div class="form-group col-md-6">
    <label for="ipt" class=" control-label "> Label / Title </label>
		<input type="text" class="form-control" name="label" required="true" value="<?php echo $f['label'];?>" />
  </div> 
		
  <div class="form-group col-md-6">
    <label for="ipt" class=" control-label "> Field </label>
		<input type="text" class="form-control" name="field" required="true" value="<?php echo $f['field'];?>" @if($f['field'] !='') readonly="1" @endif />
  </div> 
