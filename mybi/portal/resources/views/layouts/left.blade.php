        ...
        <li class="treeview">
          <a href="javascript:void(0)"> <i class="fa fa-desktop"></i> 
           ...
           <ul class="treeview-menu">
            ...
            <li @if(Request::segment(2) == 'posts') class="active" @endif><a href="{{ url('core/posts')}}"><span>{{ Lang::get('core.m_postm')}}</span></a></li>   
