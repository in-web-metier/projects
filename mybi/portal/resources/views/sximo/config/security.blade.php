    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="{{ url('sximo/config') }}"><i class="fa fa-th"></i> Configuration</a></li>
	...
	<div class="col-sm-6">
 		  ...
 		  <div class="form-group">
			...
			<div class="col-sm-8">
					...
					<label class="radio">
					<input type="radio" name="CNF_MAIL" value="phpmail" class="minimal-red"  @if($sximoconfig['cnf_mail'] =='phpmail') checked @endif /> 
					PHP MAIL System
					</label>
					
					<label class="radio">
					<input type="radio" name="CNF_MAIL" value="swift" class="minimal-red"  @if($sximoconfig['cnf_mail'] =='swift') checked @endif /> 
		  ...
		  <div class="form-group">
 		  ...
 		  <div class="form-group">
			...
			<div class="col-sm-8">
					<label class="checkbox">
					<input type="checkbox" name="CNF_RECAPTCHA" value="false" @if($sximoconfig['cnf_recaptcha'] =='true') checked @endif class="minimal-red"  /> 
					{{ Lang::get('core.fr_enable') }}
					</label>	
