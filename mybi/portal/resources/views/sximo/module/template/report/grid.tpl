...
<div class="box box-primary">
	<div class="box-header with-border">		 
		...
		@if(Session::get('gid') ==1)
			<a href="{{ URL::to('sximo/module/config/'.$pageModule) }}" class="btn btn-xs btn-default tips" title=" {{ Lang::get('core.btn_config') }}" ><i class="fa fa-ellipsis-v"></i>  {{ Lang::get('core.btn_config') }}</a>
		@endif 
		</div>
	</div>
	<div class="box-body "> 	
