 ...
 <div class="table-responsive">
		...
		<thead class="no-border">
          ...
          <tr>
            ...
            <td>
			<label >
            <input type="checkbox" name="view[<?php echo $id;?>]" value="1" class=""
            ...
            <td>
			<label >
            <input type="checkbox" name="search[<?php echo $id;?>]" value="1" class=""
	...
	?>
		<select name="required[<?php echo $id;?>]" id="required" class="form-control" style="width:150px;" >
			...
			<input type="hidden" name="prefix[<?php echo $id;?>]" value="<?php if(isset($rows['option']['prefix'])) echo $rows['option']['prefix'];?>" />
			<input type="hidden" name="sufix[<?php echo $id;?>]" value="<?php if(isset($rows['option']['sufix'])) echo $rows['option']['sufix'];?>" />
