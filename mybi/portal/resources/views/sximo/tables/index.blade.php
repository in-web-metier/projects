...
<div class="box box-primary">
	<div class="box-header with-border"> 
			<div class="box-header-tools pull-left">	
				<a href="{{ url('sximo/tables/tableconfig/')}}" class="btn btn-sm btn-default linkConfig tips" title="New Table "><i class="fa fa-plus"></i> </a>
				<a href="{{ url('sximo/tables/mysqleditor/')}}" class="btn btn-sm btn-default linkConfig tips" title="MySQL Editor"><i class="fa fa-pencil"></i>  </a>
			</div>	
			</div>
			<div class="box-body">
