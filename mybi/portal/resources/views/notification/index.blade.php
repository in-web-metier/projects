...
<div class="box box-primary">
	<div class="box-header with-border">
		<div class="box-header-tools pull-left" >
			...
			@endif 
			<a href="{{ URL::to( 'notification/search?return='.$return) }}" class="btn btn-xs btn-default" onclick="SximoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa  fa-search"></i> </a>				
	...
	<div class="box-body no-padding"> 	
	 ...
	 {!! Form::open(array('url'=>'notification/delete/0?return='.$return, 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
