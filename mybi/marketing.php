...
<section class="business demo">
    <div class="container demo">
        <ul class="nav cols">
            <li class="two-col one active" onclick="ga('send', 'event', 'Button', 'Бизнес-аналитика слайд Маркетинг');">
                <p>Маркетинг</p>
                <div></div>
            </li>
            ...
            <li class="two-col four" onclick="ga('send', 'event', 'Button', 'Бизнес-аналитика слайд Финансы');">
                ...
                <div></div></li>
            <li class="two-col six"  onclick="ga('send', 'event', 'Button', 'Бизнес-аналитика слайд Прочее');">
        ...
        <div class="slider-container">
           <div class="slider ten-col">
                <div class="wrapper-demo">
                    <div class="report">
                       <iframe width="1000" height="810" src="https://app.powerbi.com/view?r=eyJrIjoiZTFkMDQ4NDYtNDIwMS00NzI3LTg1NWItNGMxZTJkZjNjNzJhIiwidCI6IjA1YjY1OTU3LTM5NTktNDgwMC04ODhkLWViZjJkYmQ3YzMwMiIsImMiOjl9" frameborder="0" allowFullScreen="true"></iframe>
                    </div>
                    <div class="video">
                        <div class="video-left">
                            <span class="demo-report_title">Видео обзор отчета</span>
                            <iframe  width="560" height="315"  src="https://www.youtube.com/embed/VaOXNebaT-w" frameborder="0" allowfullscreen></iframe>
                        </div>
                        <div class="video-right">
                            <span class="demo-report_title">Описание</span>
                            <p>Данный отчет построен на выгрузке данных из рекламных кабинетов, Google Analytics, CRM и 1С системы Клиента, а также данных по KPI. Он отображает основные показатели маркетинговой воронки: Показы, Посещения, Заявки, Продажи, Доход. Иконки над этими показателями являются активными. Данные показатели рассматриваются в разрезе сегментов трафика, категорий продуктов, KPI, динамики. В отчете присутствует иерархия данных (drill-down) в визуализациях источников трафика и категорий продуктов. Для проваливания на уровень ниже необходимо кликнуть по стрелке вниз над соответствующей визуализацией.</p>
                        </div>
                    </div>
