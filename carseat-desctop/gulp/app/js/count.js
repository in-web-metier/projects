function CountBox() {
        ...
        if (amount < 0) {
            ...
            out = "<div class='countbox-num'><div class='countbox-days1'><span></span>" + days1 + "</div><div class='countbox-days2'><span></span>" + days2 + "</div><div class='countbox-hours-text'>Дней</div></div>" +  
            "<div class='countbox-space'></div>" +
            "<div class='countbox-num'><div class='countbox-hours1'><span></span>" + hours1 + "</div><div class='countbox-hours2'><span></span>" + hours2 + "</div><div class='countbox-hours-text'>Часов</div></div>" +
            "<div class='countbox-space'></div>" +
